...
- **Experience** — brief overview of skills and professional knowledge.  
...
| Technology | Purpose |
|-------------|----------|
| **HTML5** | Structure & layout of the website |
| **CSS3** | Styling, responsiveness, animations |
| **JavaScript (Vanilla)** | Interactivity & dynamic text animation |
...
├── web.png # Hero image (replace with your own)
├── leetcode.png # Project thumbnail
├── stopwatch.png # Project thumbnail
├── dev.jpg # Experience section icons
